...
export default function PlantList() {
    ...
    const [filters, setFilters] = useState({ watering: "", sunlight: "", care_level: "", type: "", cycle: "", origin: "" });
    ...
    const filterOptions = {
        ...
        origin: ["Europe", "North America", "South America", "Asia", "Africa", "Oceania", "United States", "Canada", "Mexico", "United Kingdom", "France", "Germany", "Italy", "Spain", "China", "Japan", "India", "Australia", "New Zealand", "Brazil", "Argentina", "South Africa"],
    };

    const parsedSearch = parseSmartSearch(searchTerm, filterOptions.origin);
    const effectiveFilters = buildEffectiveFilters(filters, parsedSearch.derivedFilters);
    ...
    return (
        <div className="min-h-screen overflow-hidden bg-[radial-gradient(circle_at_top_left,_rgba(255,255,255,0.96),_rgba(237,242,229,0.98)_36%,_rgba(214,224,198,1)_100%)] px-4 py-10 font-dm">
            ...
            <div className="relative z-10 mx-auto max-w-7xl">
                <div className="mb-12 text-center">
                    <Reveal>
                        <motion.div className="mb-5 inline-flex items-center gap-2 rounded-full border border-greenBorder/70 bg-white/90 px-5 py-2 shadow-[0_12px_30px_rgba(63,98,15,0.08)] backdrop-blur-sm">
                            <Leaf size={14} className="text-landingPageIcons" />
                            <span className="text-xs font-bold uppercase tracking-[0.22em] text-landingPageIcons">Plant Library</span>
                        </motion.div>
                    </Reveal>
                    <Reveal delay={0.08}>
                    ...
                    <Reveal delay={0.16}>
                        <p className="mx-auto mt-5 max-w-3xl text-xl font-medium leading-relaxed text-[#526647]">
                            Search, filter and discover your next green companion from our living plant collection.
                        </p>
                    </Reveal>
                </div>
