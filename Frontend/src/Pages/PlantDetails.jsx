    ...
    return [
        {
            id: "care",
            title: "Care guides",
            desc: "Watering, pruning, and cultivation articles.",
            href: gSearch(`${base} plant care watering pruning`),
            icon: BookOpen,
        },
        {
            id: "buy",
            title: "Nurseries & buy sources",
            desc: countryName ? `Local availability in ${countryName}.` : "Find nurseries and sellers.",
            href: gSearch(`${base} nursery buy${region}`),
            icon: ShoppingBag,
        },
        {
            id: "pest",
            title: "Pest & disease notes",
            desc: pestStr ? `Research on ${pestStr}.` : "Disease and pest searches.",
            href: gSearch(pestStr ? `${base} ${pestStr} pests${region}` : `${base} pests diseases${region}`),
            icon: Bug,
        },
        {
            id: "inspo",
            title: "Planting inspiration",
            desc: "Garden styling and companion planting photos.",
            href: gSearch(`${base} garden design companion plants`, true),
            icon: Search,
        },
        {
            id: "video",
            title: "Video walkthroughs",
            desc: "Hands-on care guides on YouTube.",
            href: ytSearch(`${base} plant care guide`),
            icon: ExternalLink,
        },
    ];
};
...
const riskStyle = (label) => {
    if (label === "high") {
        return {
            badge: "bg-[#ffe5e1] text-[#b04436] border-[#f5c1ba]",
            panel: "border-[#f5c1ba] bg-[linear-gradient(140deg,#fff8f6,#fff1ee)]",
            dot: "bg-[#e05c4a]",
            title: "High local pest exposure",
        };
    }

    if (label === "caution") {
        return {
            badge: "bg-[#fff1d6] text-[#9d6b09] border-[#f0d39d]",
            panel: "border-[#f0d39d] bg-[linear-gradient(140deg,#fffaf0,#fff5e0)]",
            dot: "bg-[#e9a030]",
    ...
    if (label === "low") {
        return {
            badge: "bg-[#e9f6dc] text-[#49661d] border-[#c8ddae]",
            panel: "border-[#c8ddae] bg-[linear-gradient(140deg,#f8fcf2,#eef6e1)]",
            dot: "bg-[#6aaa2e]",
            title: "Low local pest risk",
        };
    }

    return {
        badge: "bg-[#eef3e7] text-greenMid border-[#dbe6cf]",
        panel: "border-[#dbe6cf] bg-[linear-gradient(140deg,#fafcf7,#f4f8ee)]",
        dot: "bg-greenMid/60",
        title: "Pest risk unavailable",
    };
};
...
const CareCard = ({ icon, iconBg, title, children }) => (
    ...
    >
        <div className="mb-4 flex items-center gap-3">
            <div className={`flex h-10 w-10 items-center justify-center rounded-[15px] ${iconBg}`}>
                {icon}
            </div>
        ...
        return (
            <div className="flex min-h-screen flex-col items-center justify-center gap-5 bg-[radial-gradient(circle_at_top_left,_rgba(255,255,255,0.96),_rgba(237,242,229,0.98)_36%,_rgba(214,224,198,1)_100%)]">
                <div className="rounded-[28px] border border-[#dbe6cf] bg-white/90 p-10 text-center shadow-[0_24px_60px_rgba(52,78,24,0.1)]">
                    ...
                    <Link
                        to="/plants"
                        className="inline-flex items-center gap-2 rounded-full bg-landingPageIcons px-6 py-3 text-sm font-bold text-white shadow-green-btn transition hover:-translate-y-0.5 hover:bg-darkLandingPageIcons"
                    >
                ...
                {items.map((pest, i) => (
                    ...
                    >
                        <div className="flex items-start gap-3.5 p-4">
                            {pest.thumbnailUrl ? (
                                <a
                                    href={pest.imageUrl || pest.thumbnailUrl}
                                    target="_blank"
                                    rel="noreferrer"
                                    className="shrink-0"
                                >
                        ...
                        <motion.button
                            ...
                            className={`inline-flex items-center gap-2 rounded-full border px-4 py-2 text-sm font-semibold transition ${
                                fav
                                    ...
                                    : "border-[#dbe6cf] bg-white/80 text-greenDark hover:border-yellow-400 hover:bg-yellow-50"
                            }`}
                        >
                ...
                <Reveal>
                    <div className="mb-8 overflow-hidden rounded-[36px] border border-white/80 bg-white/92 shadow-[0_32px_90px_rgba(52,78,24,0.13)] backdrop-blur-sm">
                        <div className="grid lg:grid-cols-[1fr_1.2fr]">
                            <div
                                className="relative overflow-hidden bg-[linear-gradient(135deg,#d5e3be,#b8ce92)]"
                                ...
                                {quickFacts.length > 0 ? (
                                    <div className="mt-7 grid grid-cols-2 gap-2 border-t border-[#e8f0dd] pt-6 sm:grid-cols-3 xl:grid-cols-5">
                                        {quickFacts.map((fact) => (
                                            ...
                                            >
                                                <div className="text-[9px] font-bold uppercase tracking-[0.2em] text-greenMid">
                                                    {fact.label}
                                                </div>
                        ...
                        <Reveal>
                            <div className="rounded-[30px] border border-[#d2e0bc] bg-[linear-gradient(145deg,rgba(255,255,255,0.96),rgba(244,249,236,0.96))] p-7 shadow-[0_22px_60px_rgba(52,78,24,0.11)] md:p-8">
                                ...
                                <div className="grid gap-3.5 sm:grid-cols-2">
                                    <CareCard
                                        icon={<Droplets size={16} className="text-[#74a5ff]" />}
                                        iconBg="bg-[#eef3ff]"
                                        title="Watering"
                                    >
                                    ...
                                    <CareCard
                                        icon={<Sun size={16} className="text-[#f5a623]" />}
                                        iconBg="bg-[#fff7ec]"
                                        title="Sunlight"
                                    >
                                    ...
                                    <CareCard
                                        icon={<Scissors size={16} className="text-[#9461d6]" />}
                                        iconBg="bg-[#f6f2ff]"
                                        title="Pruning"
                                    >
                                    ...
                                    <CareCard
                                        icon={<Sprout size={16} className="text-landingPageIcons" />}
                                        iconBg="bg-[#f2f8ea]"
                                        title="Propagation"
                                    >
                                        <p className="text-sm leading-6 text-greenDark">
                                ...
                                {details.soil?.length || details.hardiness?.min || details.hardiness?.max ? (
                                    <div className="mt-5 flex flex-wrap items-center gap-2 border-t border-[#edf3e4] pt-5">
                                        {details.soil?.length ? (
                                            <>
                                                <span className="mr-1 text-[10px] font-bold uppercase tracking-[0.16em] text-greenMid">
                                                    Soil
                                                </span>
                                                {details.soil.map((s) => (
                                                    <span
                                                        key={s}
                                                        className="rounded-full border border-[#dbe6cf] bg-[#f4f8ed] px-3 py-1.5 text-[11px] font-semibold text-landingPageIcons"
                                                    >
                                                        {s}
                                                    </span>
                                                ))}
                                ...
                                {pests.length > 0 ? (
                                    <>
                                        <div className="mb-5 flex flex-wrap gap-2">
                                            {majorPests.length ? (
                                                <span className="rounded-full border border-[#f5c1ba] bg-[#ffe8e3] px-3.5 py-1.5 text-[11px] font-bold text-[#b04436]">
                                                    Major host · {majorPests.length}
                                                </span>
                                            ) : null}

                                            {hostPests.length ? (
                                                <span className="rounded-full border border-[#dbe6cf] bg-[#f4f8ed] px-3.5 py-1.5 text-[11px] font-bold text-landingPageIcons">
                                                    Host · {hostPests.length}
                                                </span>
                                            ) : null}

                                            {experimentalPests.length ? (
                                                <span className="rounded-full border border-[#f0d39d] bg-[#fff9ef] px-3.5 py-1.5 text-[11px] font-bold text-[#9d6b09]">
                                                    Experimental · {experimentalPests.length}
                                                </span>
                                            ) : null}
                                        </div>
                                    ...
                                    {pestRisk?.warnings?.length ? (
                                        <div className="space-y-2.5">
                                            {pestRisk.warnings.slice(0, 4).map((warning) => (
                                                <div
                                                    key={warning}
                                                    className="flex items-start gap-3 rounded-[16px] border border-white/65 bg-white/55 px-4 py-3"
                                                >
                        ...
                        <Reveal>
                            ...
                            >
                                <div className="space-y-2">
                                    {[
                                        ...
                                        .map((item) => (
                                            ...
                                            >
                                                <span className="text-[10px] font-bold uppercase tracking-[0.16em] text-greenMid">
                                                    {item.label}
                                                </span>
                                ...
                                {details.origin?.length ? (
                                    <div className="mt-5">
                                        <p className="mb-2.5 text-[10px] font-bold uppercase tracking-[0.16em] text-greenMid">
                                            Origin
                                        </p>
                                        <div className="flex flex-wrap gap-2">
                                            {details.origin.map((place) => (
                                                <span
                                                    key={place}
                                                    className="rounded-full border border-[#dbe6cf] bg-[#f4f8ed] px-3 py-1.5 text-[11px] font-medium text-greenDark"
                                                >
                                                    {place}
                                                </span>
                                            ))}
